...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/search_poems \
  -H 'Content-Type: application/json' \
  -d '{"title":"The Road Not Taken"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/search_poems`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
